...
To run the complete unit test suite validating risk calculations and sorting arrays:
```bash
npm test
```
*(10/10 tests are green, covering boundary thresholds, sorting hierarchies, and API mocks).*
