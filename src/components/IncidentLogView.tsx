...
export default function IncidentLogView({
  isHighContrast,
  reducedMotion,
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setError(
        err.message || "Network error. Unable to load emergency log telemetry.",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-neutral-500">
              Real-time audit trails of active and resolved tournament safety
              breaches, crowded blockages, and staff tasks.
            </p>
          </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="critical">
                    Critical (High Level / Police / Medical)
                  </option>
                </select>
              </div>
            </div>
          ...
          >
            ...
            {isLoading && incidents.length === 0 ? (
              <div className="py-24 text-center text-xs text-neutral-400 space-y-2.5">
                ...
                <p>
                  Establishing secure socket connection to MetLife IoT log
                  server...
                </p>
              </div>
              ...
              <div className="py-24 text-center text-xs text-neutral-400 space-y-1.5">
                ...
                <p className="font-bold text-neutral-600">
                  No matching incident logs cataloged
                </p>
                <p className="max-w-xs mx-auto text-[11px]">
                  All streams nominal. Adjust search queries or filters to
                  explore alternative historical records.
                </p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="space-y-1.5 flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <span
                          className={`font-bold font-display text-sm ${inc.status === "resolved" ? "line-through" : "text-neutral-900"}`}
                        >
                          {inc.zoneName}
                        </span>
                      ...
                      <p
                        className={`text-[11px] leading-relaxed ${inc.status === "resolved" ? "line-through opacity-80" : "text-neutral-700 font-semibold"}`}
                      >
                        {inc.message}
                      </p>
